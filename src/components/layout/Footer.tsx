...
const carLinks = [
  { href: "/mobil/almaz", label: "Wuling Almaz" },
  { href: "/mobil/almaz-rs", label: "Wuling Almaz RS" },
  { href: "/mobil/alvez", label: "Wuling Alvez" },
  { href: "/mobil/cortez", label: "Wuling Cortez" },
  { href: "/mobil/air-ev", label: "Wuling Air ev" },
  { href: "/mobil/binguo-ev", label: "Wuling BinguoEV" },
];
          ...
          <ul className="space-y-2.5">
            {navLinks.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="text-sm text-gray-300 hover:text-wuling-red transition-colors"
                >
                  {link.label}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex gap-3 text-sm text-gray-300">
              ...
              <a href={`tel:${dealerInfo.phone}`} className="hover:text-wuling-red transition-colors">
                {dealerInfo.phone}
              </a>
            </li>
            <li className="flex gap-3 text-sm text-gray-300">
              <Mail size={16} className="text-wuling-red shrink-0 mt-0.5" />
              <a href={`mailto:${dealerInfo.email}`} className="hover:text-wuling-red transition-colors">
                {dealerInfo.email}
              </a>
            </li>
            <li className="flex gap-3 text-sm text-gray-300">
              ...
              <div className="space-y-0.5">
                <p>Senin – Jumat: {dealerInfo.hours.weekday}</p>
                <p>Sabtu: {dealerInfo.hours.saturday}</p>
                <p>Minggu: {dealerInfo.hours.sunday}</p>
              </div>
            </li>
          </ul>
        </div>
